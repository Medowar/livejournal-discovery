...
More information about the archiving project can be found on the ArchiveTeam wiki: [LiveJournal](http://archiveteam.org/index.php?title=LiveJournal)
...
Follow the [instructions on the ArchiveTeam wiki](http://archiveteam.org/index.php?title=Warrior) for installing the Warrior, and select the "LiveJournal Discovery" project in the Warrior interface.
...
6. `screen su -c "cd /home/archiveteam/livejournal-discovery/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
